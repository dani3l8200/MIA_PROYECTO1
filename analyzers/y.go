...
var yyAct = [...]int{
	3, 7, 4, 5, 6, 8, 14, 2, 13, 12,
	11, 10, 9, 1,
}

var yyPact = [...]int{
	-1000, -4, -1000, 1, 0, -1, -2, -3, -6, -1000,
...
//line parser.y:47
		{
			yyVAL.node = Node("float")
		}
	case 5:
		yyDollar = yyS[yypt-2 : yypt+1]
//line parser.y:48
		{
			yyVAL.node = Node("char")
		}
	case 6:
		yyDollar = yyS[yypt-2 : yypt+1]
//line parser.y:49
		{
			yyVAL.node = Node("string")
		}
	case 7:
		yyDollar = yyS[yypt-2 : yypt+1]
//line parser.y:50
		{
			yyVAL.node = Node("bool")
		}
	case 8:
		yyDollar = yyS[yypt-2 : yypt+1]
//line parser.y:51
